...
import { durationToMinutes } from "@/lib/format-duration";
        ...
        ? [
            {
              ...
              children: JSON.stringify({
                ...
                prepTime: `PT${durationToMinutes(r.prep_time) ?? 0}M`,
                cookTime: `PT${durationToMinutes(r.cook_time) ?? 0}M`,
                totalTime: `PT${(durationToMinutes(r.prep_time) ?? 0) + (durationToMinutes(r.cook_time) ?? 0)}M`,
