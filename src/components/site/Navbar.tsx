...
import logo from "@/assets/logo_petites_plates_de_ludo.jpg";
      ...
      <nav className="container mx-auto flex h-20 items-center justify-between gap-6 px-4 md:px-8">
        <Link to="/" className="group flex items-center gap-3">
          <motion.div
            ...
            className="grid h-14 w-14 place-items-center rounded-full bg-[var(--gradient-warm)] text-primary-foreground shadow-[var(--shadow-warm)]"
          >
            <img
              src={logo}
              alt="Les Petits Plats de Ludo"
